...
Estado actual: **v4.14.0** (tanda `multidivisa`; producción 4.13.0) — detalle en [docs/ROADMAP.md](docs/ROADMAP.md), [CHANGELOG.md](CHANGELOG.md) y [docs/ARQUITECTURA.md](docs/ARQUITECTURA.md).
