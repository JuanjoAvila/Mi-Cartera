...
Estado actual: **v4.13.0** (canal `beta`; producción en `main` va por **v4.12.3** — el arranque de esta misma ronda, ya subido por separado) — detalle en [docs/ROADMAP.md](docs/ROADMAP.md), [CHANGELOG.md](CHANGELOG.md) y [docs/ARQUITECTURA.md](docs/ARQUITECTURA.md).
