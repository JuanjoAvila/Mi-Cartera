...
Estado actual: **v4.12.1** (canal `beta`; producción en `main` va por **v4.12.0**) — detalle en [docs/ROADMAP.md](docs/ROADMAP.md), [CHANGELOG.md](CHANGELOG.md) y [docs/ARQUITECTURA.md](docs/ARQUITECTURA.md).
