...
const LANG = {
  es:{
    tab_dash:"Resumen", tab_gastos:"Gastos", tab_fijos:"Fijos", tab_inv:"Inversiones", tab_patri:"Patrimonio", tab_debt:"Deudas", tab_compartido:"Compartido",
    tb_add:"Añadir pestaña", tb_add_hint:"Toca la que quieras ver en la barra. Para quitar una, mantenla pulsada y arrástrala a la papelera.",
    tb_trash:"Suéltala aquí para quitarla", tb_removed:"Pestaña quitada · recupérala con el botón +", tb_nodel:"El Resumen no se puede quitar",
    st_mode:"Modo de la app", st_mode_full:"Completo", st_mode_simple:"Sencillo", st_mode_hint:"Sencillo deja solo Resumen, Gastos y Fijos. Ideal para empezar o para quien quiere lo básico.",
    ...
    st_custom:"Personalización", st_widgets:"Personalizar widgets del Resumen", st_notifs:"Notificaciones", st_simple_lbl:"Modo sencillo",
    ...
    st_news:"Novedades", st_news_row:"Novedades y sugerencias",
    ...
    st_sentry:"Sentry (errores en prod)", st_sentry_test:"Enviar error de prueba", st_sentry_sent:"✓ Enviado a Sentry (mira Issues en unos segundos)", st_sentry_hint:"El DSN lo inyecta el deploy. Solo aparece este bloque si la versión publicada lleva Sentry activo.",
  ...
  en:{
    tab_dash:"Summary", tab_gastos:"Spending", tab_fijos:"Fixed", tab_inv:"Investments", tab_patri:"Net worth", tab_debt:"Debts", tab_compartido:"Shared",
    tb_add:"Add tab", tb_add_hint:"Tap the one you want on the bar. To remove one, long-press it and drag it to the bin.",
    tb_trash:"Drop it here to remove", tb_removed:"Tab removed · bring it back with +", tb_nodel:"Summary can't be removed",
    st_mode:"App mode", st_mode_full:"Full", st_mode_simple:"Simple", st_mode_hint:"Simple keeps only Summary, Spending and Fixed. Great to start or for anyone who wants the basics.",
    ...
    st_custom:"Customisation", st_widgets:"Customise Summary widgets", st_notifs:"Notifications", st_simple_lbl:"Simple mode",
    ...
    st_news:"What's new", st_news_row:"What's new & feedback",
    ...
    st_sentry:"Sentry (prod errors)", st_sentry_test:"Send test error", st_sentry_sent:"✓ Sent to Sentry (check Issues in a few seconds)", st_sentry_hint:"The DSN is injected on deploy. This block only shows if the published build has Sentry on.",
  ...
  ca:{
    tab_dash:"Resum", tab_gastos:"Despeses", tab_fijos:"Fixes", tab_inv:"Inversions", tab_patri:"Patrimoni", tab_debt:"Deutes", tab_compartido:"Compartit",
    ...
    tb_trash:"Deixa-la aquí per treure-la", tb_removed:"Pestanya treta · recupera-la amb el botó +", tb_nodel:"El Resum no es pot treure",
    st_mode:"Mode de l'app", st_mode_full:"Complet", st_mode_simple:"Senzill", st_mode_hint:"Senzill deixa només Resum, Despeses i Fixes. Ideal per començar o per qui vol el bàsic.",
    ...
    st_custom:"Personalització", st_widgets:"Personalitza els widgets del Resum", st_notifs:"Notificacions", st_simple_lbl:"Mode senzill",
    ...
    st_news:"Novetats", st_news_row:"Novetats i suggeriments",
    ...
    st_sentry:"Sentry (errors en prod)", st_sentry_test:"Envia error de prova", st_sentry_sent:"✓ Enviat a Sentry (mira Issues en uns segons)", st_sentry_hint:"El DSN l'injecta el deploy. Aquest bloc només surt si la versió publicada porta Sentry actiu.",
...
const LANG_SIMPLE = {
  es:{ d_networth:"Tu dinero en total", d_assets:"Lo que tienes", tab_fijos:"Recibos" },
  en:{ d_networth:"All your money",     d_assets:"What you have", tab_fijos:"Bills" },
  ca:{ d_networth:"Els teus diners en total", d_assets:"El que tens", tab_fijos:"Rebuts" },
};
const t = (k)=>{
...
Object.assign(LANG.es,{
  ...
  tour_1:"💰 Este es tu dinero. Aquí ves cuánto tienes en total y cómo va el mes.",
  tour_2:"🧾 «{gastos}» = solo el día a día (súper, bares, ropa…). Arriba filtras por mes, categoría o banco. Nómina o Bizum recibido: botón «+» → Ingreso (o chip 💰 Ingreso). Los recibos NO van aquí.",
  tour_3:"📅 «{fijos}» = lo que se repite cada mes: luz, agua, Netflix, hipoteca, cuotas… Si el banco está conectado, Conciliación te propone lo cobrado. Lo del súper va en Gastos, no aquí.",
  tour_4:"⚙️ Aquí están los Ajustes: idioma, colores, letra grande y el modo sencillo.",
  tour_5:"☁️ Con tu cuenta, todo se guarda solo y no se pierde aunque cambies de móvil. ¡Ya está!",
  tour_6:"👆 Las pestañas son tuyas: reordénalas, ocúltalas o vuelve a añadirlas desde Ajustes › «✎ Editar pestañas». Con el «+» de la barra añades las que quieras.",
  tour_7:"🏛 En «{patri}» está TODO lo tuyo junto: cuentas, inversiones, bienes y deudas. Toca «Editar» para corregir cualquier saldo: la app se re-cuadra sola.",
  tour_8:"❓ Si ves un «?» en una tarjeta, tócalo: te explica esa tarjeta en cristiano, sin jerga. Hay uno en casi todas.",
...
Object.assign(LANG.en,{
  ...
  tour_1:"💰 This is your money. Here you see how much you have in total and how the month is going.",
  tour_2:"🧾 “{gastos}” = day-to-day only (groceries, bars, clothes…). Filter by month, category or bank up top. Salary or Bizum in: “+” → Income (or the 💰 Income chip). Bills do NOT go here.",
  tour_3:"📅 “{fijos}” = what repeats each month: power, water, Netflix, mortgage, instalments… With a bank linked, Reconciliation suggests what was charged. Groceries go in Spending, not here.",
  tour_4:"⚙️ Here are the Settings: language, colours, large text and simple mode.",
  tour_5:"☁️ With your account everything saves itself and survives changing phones. That's it!",
  tour_6:"👆 The tabs are yours: reorder, hide or add them back from Settings › «✎ Edit tabs». Add more with the «+» in the bar.",
  tour_7:"🏛 «{patri}» holds EVERYTHING you own: accounts, investments, assets and debts. Tap “Edit” to fix any balance — the app re-balances itself.",
  tour_8:"❓ See a «?» on a card? Tap it: it explains that card in plain words, no jargon. Almost every card has one.",
...
Object.assign(LANG.ca,{
  ...
  tour_1:"💰 Aquests són els teus diners. Aquí veus quant tens en total i com va el mes.",
  tour_2:"🧾 «{gastos}» = només el dia a dia (súper, bars, roba…). A dalt filtres per mes, categoria o banc. Nòmina o Bizum rebut: botó «+» → Ingrés (o xip 💰 Ingrés). Els rebuts NO van aquí.",
  tour_3:"📅 «{fijos}» = el que es repeteix cada mes: llum, aigua, Netflix, hipoteca, quotes… Si el banc està connectat, Conciliació et proposa el cobrat. El súper va a Despeses, no aquí.",
  tour_4:"⚙️ Aquí hi ha la Configuració: idioma, colors, lletra gran i el mode senzill.",
  tour_5:"☁️ Amb el teu compte tot es desa sol i no es perd encara que canviïs de mòbil. Ja està!",
  tour_6:"👆 Les pestanyes són teves: reordena-les, amaga-les o torna-les a afegir des d'Ajustos › «✎ Edita pestanyes». Amb el «+» de la barra n'afegeixes més.",
  tour_7:"🏛 A «{patri}» hi ha TOT el que és teu: comptes, inversions, béns i deutes. Toca «Edita» per corregir qualsevol saldo: l'app es re-quadra sola.",
  tour_8:"❓ Si veus un «?» en una targeta, toca'l: t'explica aquella targeta en cristià, sense argot. N'hi ha un a gairebé totes.",
...
Object.assign(LANG.es,{
  ...
  bi_metal_hint:"🥇 Materias primas: Revolut no dice en este extracto cuánto te costaron (esa parte va en el extracto de tu cuenta en €), así que solo re-anclo las ONZAS y respeto el coste que ya tuvieras. Con las onzas basta: el precio del metal ya se actualiza en vivo.",
...
Object.assign(LANG.en,{
  ...
  bi_metal_hint:"🥇 Commodities: this statement doesn't say what they cost you (that part lives in your € account statement), so I only re-anchor the OUNCES and keep whatever cost you had. Ounces are enough: the metal price already updates live.",
...
Object.assign(LANG.ca,{
  ...
  bi_metal_hint:"🥇 Matèries primeres: en aquest extracte Revolut no diu quant et van costar (aquesta part va a l'extracte del teu compte en €), així que només re-ancoro les UNCES i respecto el cost que ja tinguessis. Amb les unces n'hi ha prou: el preu del metall ja s'actualitza en viu.",
...
Object.assign(LANG.es,{
  ...
  tr_hint:"Conecta tu cuenta de Trade Republic y trae tus posiciones al momento (participaciones, valor y coste), sin exportar nada a mano. Solo LEE: nunca opera ni mueve dinero.",
  tr_beta:"BETA",
  ...
  tr_tos:"⚠ Conexión NO oficial: usa la misma vía que la web de TR. Puede pedir el código de 2FA de tu app cada cierto tiempo y podría dejar de funcionar si TR cambia algo. Tus credenciales no se guardan en la nube de Mi Cartera.",
  ...
  mi_recaptcha:"MyInvestor pide una verificación extra ahora mismo (reCAPTCHA). Espera un rato y vuelve a intentarlo.",
...
Object.assign(LANG.en,{
  ...
  tr_hint:"Connect your Trade Republic account and pull your positions instantly (shares, value and cost), no manual export. Read-only: it never trades or moves money.",
  tr_beta:"BETA",
  ...
  tr_tos:"⚠ UNofficial connection: uses the same path as TR's web. It may ask for your app's 2FA code every so often and could stop working if TR changes something. Your credentials are not stored in Mi Cartera's cloud.",
  ...
  mi_hint:"Use your MyInvestor username and password. The password is used only to log in and is NOT stored anywhere: only the session is kept (like logging into their website).",
  ...
  mi_recaptcha:"MyInvestor is asking for an extra check right now (reCAPTCHA). Wait a bit and try again.",
...
Object.assign(LANG.ca,{
  ...
  tr_hint:"Connecta el teu compte de Trade Republic i porta les teves posicions a l'instant (participacions, valor i cost), sense exportar res a mà. Només LLEGEIX: mai no opera ni mou diners.",
  tr_beta:"BETA",
  ...
  tr_tos:"⚠ Connexió NO oficial: fa servir la mateixa via que la web de TR. Pot demanar el codi de 2FA de la teva app cada cert temps i podria deixar de funcionar si TR canvia alguna cosa. Les teves credencials no es guarden al núvol de Mi Cartera.",
  ...
  mi_hint:"Fes servir el teu usuari i contrasenya de MyInvestor. La contrasenya s'usa només per al login i NO es desa enlloc: només es desa la sessió (com quan entres a la seva web).",
  ...
  mi_recaptcha:"MyInvestor demana una verificació extra ara mateix (reCAPTCHA). Espera una estona i torna-ho a provar.",
...
Object.assign(LANG.es,{
  ...
  g_cycle_from:"Del {d} (cobro de {x}) a hoy", g_cycle_none:"No encuentro ningún cobro reciente: apunta tu nómina como 💰 ingreso y este filtro irá de cobro a cobro.",
  ...
  cat_super:"Supermercado", cat_pan:"Panadería", cat_bares:"Bares y restaurantes", cat_ocio:"Ocio", cat_transporte:"Transporte", cat_parking:"Parking", cat_tasas:"Impuestos y multas", cat_compras:"Compras", cat_salud:"Salud", cat_pelu:"Peluquería", cat_hogar:"Hogar", cat_regalos:"Regalos", cat_otros:"Otros", cat_ingreso:"Ingreso",
...
Object.assign(LANG.en,{
  ...
  g_cycle_from:"From {d} (payday, {x}) to today", g_cycle_none:"No recent payday found: log your salary as a 💰 income and this filter will run payday to payday.",
  ...
  cat_super:"Groceries", cat_pan:"Bakery", cat_bares:"Bars & restaurants", cat_ocio:"Leisure", cat_transporte:"Transport", cat_parking:"Parking", cat_tasas:"Taxes & fines", cat_compras:"Shopping", cat_salud:"Health", cat_pelu:"Hair & beauty", cat_hogar:"Home", cat_regalos:"Gifts", cat_otros:"Other", cat_ingreso:"Income",
...
Object.assign(LANG.ca,{
  ...
  g_cycle_from:"Del {d} (cobrament de {x}) a avui", g_cycle_none:"No trobo cap cobrament recent: apunta la nòmina com a 💰 ingrés i aquest filtre anirà de cobrament a cobrament.",
  ...
  cat_super:"Supermercat", cat_pan:"Fleca", cat_bares:"Bars i restaurants", cat_ocio:"Oci", cat_transporte:"Transport", cat_parking:"Pàrquing", cat_tasas:"Impostos i multes", cat_compras:"Compres", cat_salud:"Salut", cat_pelu:"Perruqueria", cat_hogar:"Llar", cat_regalos:"Regals", cat_otros:"Altres", cat_ingreso:"Ingrés",
  freq_mes:"mensual", freq_bimestral:"bimestral", freq_trimestral:"trimestral", freq_semestral:"semestral", "freq_año":"anual",
...
// Letra grande (accesibilidad): escala toda la app un 12% (settings.bigText)
function applyBigText(on){ try{ document.documentElement.classList.toggle("bigtext", !!on); }catch(e){} }
...
function loadState(){
  ...
  applyBigText(init.settings&&init.settings.bigText);
  return init;
}
