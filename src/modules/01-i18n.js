...
const LANG = {
  es:{
    ...
    rp_saved:"✓ Informe descargado (no se pudo abrir el menú de compartir)",
  ...
  en:{
    ...
    rp_saved:"✓ Report downloaded (share menu unavailable)",
    ob_welcome:"Welcome 👋",
  ...
  ca:{
    ...
    rp_saved:"✓ Informe descarregat (no s'ha pogut obrir el menú de compartir)",
