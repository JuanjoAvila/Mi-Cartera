...
Object.assign(LANG.es,{
  ...
  tour_2:"🧾 En «{gastos}» apuntas lo que gastas día a día. Toca «+ Añadir», pon cuánto y en qué, y ya está.",
  tour_3:"📅 En «{fijos}» están los pagos de cada mes (luz, agua, hipoteca…). La app te avisa si no te va a llegar.",
...
Object.assign(LANG.en,{
  ...
  tour_2:"🧾 In “{gastos}” you jot down day-to-day spending. Tap “+ Add”, enter how much and what for, done.",
  tour_3:"📅 In “{fijos}” live the monthly payments (power, water, mortgage…). The app warns you if you won't make it.",
...
Object.assign(LANG.ca,{
  ...
  tour_2:"🧾 A «{gastos}» apuntes el que gastes dia a dia. Toca «+ Afegeix», posa quant i en què, i llest.",
  tour_3:"📅 A «{fijos}» hi ha els pagaments de cada mes (llum, aigua, hipoteca…). L'app t'avisa si no hi arribaràs.",
...
Object.assign(LANG.es,{
  ...
  sh_newdefault:"Grupo", sh_newgroup:"Nuevo grupo compartido", sh_name_ph:"Nombre (ej. Crucero)", sh_you:"Tú", sh_other_ph:"Otra persona (ej. Pareja)", sh_create:"Crear grupo", sh_cancel:"Cancelar",
...
Object.assign(LANG.en,{
  ...
  sh_newdefault:"Group", sh_newgroup:"New shared group", sh_name_ph:"Name (e.g. Cruise)", sh_you:"You", sh_other_ph:"Other person (e.g. Partner)", sh_create:"Create group", sh_cancel:"Cancel",
...
Object.assign(LANG.ca,{
  ...
  sh_newdefault:"Grup", sh_newgroup:"Nou grup compartit", sh_name_ph:"Nom (ex. Creuer)", sh_you:"Tu", sh_other_ph:"Altra persona (ex. Parella)", sh_create:"Crea grup", sh_cancel:"Cancel·la",
