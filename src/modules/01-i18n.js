...
const LANG = {
  es:{
    ...
    v4_expdaily_chip:"En gasto diario", v4_expdaily_row_hint:"Puedes marcar «Gasto diario» en varios bancos: sus compras cuentan en el mismo presupuesto del día. La primera es la cuenta principal (de la que sale el efectivo); las demás solo suman sus gastos.",
  ...
  en:{
    ...
    v4_expdaily_chip:"In daily spending", v4_expdaily_row_hint:"You can set «Daily spending» on several banks: their purchases count toward the same daily budget. The first is the main account (where the cash comes from); the others only add their spending.",
  ...
  ca:{
    ...
    v4_expdaily_chip:"En despesa diària", v4_expdaily_row_hint:"Pots marcar «Despesa diària» a diversos bancs: les seves compres compten al mateix pressupost del dia. El primer és el compte principal (d'on surt l'efectiu); els altres només sumen les seves despeses.",
