...
var RELEASE_NOTES=[
  {v:"4.12.0", d:"26 jul 2026",
   ...
   es:[
    ...
    "🖐️ Se acabó que la pantalla se quede trabada al deslizar: movías el dedo, no pasaba nada, y de pronto pegaba un salto. Ocurría cuando el móvil se quedaba con el gesto a medias —algo muy habitual si la lista todavía se estaba moviendo—; ahora la app lo suelta sola.",
   ...
   en:[
    ...
    "🖐️ No more screen getting stuck when you swipe: you moved your finger, nothing happened, and then it suddenly jumped. It happened whenever the phone took over the gesture halfway through —very common while the list is still moving—; the app now lets go on its own.",
   ...
   ca:[
    ...
    "🖐️ S'ha acabat que la pantalla es quedi travada en lliscar: movies el dit, no passava res, i de cop feia un salt. Passava quan el mòbil es quedava amb el gest a mitges —molt habitual si la llista encara s'està movent—; ara l'app el deixa anar sola.",
