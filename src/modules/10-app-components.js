...
var RELEASE_NOTES=[
  {v:"4.12.0", d:"26 jul 2026",
   ...
   es:[
    ...
    "🎯 Sobre todo al volver de Deudas a Gastos: esa dirección iba con tirón y hacia Cartera no. Ya no reconstruye Gastos al llegar; el gesto llega limpio en los dos sentidos.",
   ...
   en:[
    ...
    "🎯 Especially going back from Debts to Expenses: that direction used to hitch, and towards Portfolio it did not. Expenses is no longer rebuilt on arrival; the swipe is clean both ways.",
   ...
   ca:[
    ...
    "🎯 Sobretot en tornar de Deutes a Despeses: aquella direcció anava amb estrebada i cap a Cartera no. Ja no reconstrueix Despeses en arribar; el gest arriba net en els dos sentits.",
