...
var RELEASE_NOTES=[
  {v:"4.13.0", d:"28 jul 2026",
   t:{es:"Trae tus gastos desde un Excel, y la app se mueve como te gusta",
      en:"Bring your expenses in from a spreadsheet, and the app moves the way you like",
      ca:"Porta les teves despeses des d'un Excel, i l'app es mou com t'agrada"},
   ...
   tandas:[
    {id:"import", t:"📗 Importar hojas de gastos", items:[
      "Ajustes → Copia de seguridad → «Importar una hoja de gastos» abre la pantalla.",
      "Un Excel (.xlsx) tuyo o de tu madre se lee y propone solo qué es cada columna.",
      "Un CSV también entra, con punto y coma o con coma.",
      "Antes de guardar ves el reparto: cuántos entran y cuántos ya los tenías.",
      "Lo repetido se descarta solo y no ensucia el histórico.",
