...
var RELEASE_NOTES=[
  {v:"4.16.0", d:"6 ago 2026",
   ...
   tandas:[
    {id:"presupuesto-aviso",
     t:{es:"🔔 El aviso del presupuesto dice la verdad",
        en:"🔔 The budget alert tells the truth",
        ca:"🔔 L'avís del pressupost diu la veritat"},
     items:{
      es:["El número de «gastado este mes» del widget es el mismo que sale arriba en Gastos.",
          "Si salta un aviso de presupuesto (50%, 80%, 95%), la cifra que dice cuadra con la app.",
          "Los recibos del banco de gastos fijos ya no cuentan para el presupuesto.",
          "Las inversiones y los traspasos entre cuentas tampoco cuentan."],
      en:["The widget's «spent this month» matches the figure at the top of Spending.",
          "If a budget alert fires (50%, 80%, 95%), its figure matches the app.",
          "Bills from the fixed-costs bank no longer count toward the budget.",
          "Investments and transfers between accounts don't count either."],
      ca:["El número de «gastat aquest mes» del widget és el mateix que surt a dalt a Despeses.",
          "Si salta un avís de pressupost (50%, 80%, 95%), la xifra que diu quadra amb l'app.",
          "Els rebuts del banc de despeses fixes ja no compten per al pressupost.",
          "Les inversions i els traspassos entre comptes tampoc no compten."]}},
    {id:"divisa-original",
     t:{es:"💱 Lo que costó en su moneda se queda escrito",
        en:"💱 What it cost in its own currency stays written down",
        ca:"💱 El que va costar en la seva moneda es queda escrit"},
     items:{
      es:["Apuntar un gasto en otra moneda (₺, $…): en el detalle del gasto se ve lo que costó de verdad, junto a la fecha.",
          "Cerrar la app, volver a abrirla y comprobar que la moneda sigue ahí (antes se perdía al sincronizar).",
          "Editar el importe en euros a mano: la cifra en la otra moneda desaparece, porque ya no corresponde.",
          "Un gasto normal en euros no enseña ninguna moneda de más."],
      en:["Log an expense in another currency (₺, $…): the expense detail shows what it really cost, next to the date.",
          "Close the app, reopen it and check the currency is still there (it used to vanish on sync).",
          "Edit the euro amount by hand: the other currency disappears, because it no longer matches.",
          "A normal euro expense shows no extra currency."],
      ca:["Apuntar una despesa en una altra moneda (₺, $…): al detall es veu el que va costar de veritat, al costat de la data.",
          "Tancar l'app, tornar-la a obrir i comprovar que la moneda hi continua (abans es perdia en sincronitzar).",
          "Editar l'import en euros a mà: la xifra en l'altra moneda desapareix, perquè ja no correspon.",
          "Una despesa normal en euros no ensenya cap moneda de més."]}},
    {id:"notis-wallet",
     t:{es:"💳 Las compras con Google Pay también se apuntan solas",
        en:"💳 Google Pay purchases get logged on their own too",
        ca:"💳 Les compres amb Google Pay també s'apunten soles"},
     items:{
      es:["Pagar con el móvil (Google Pay) con cualquier tarjeta: el gasto entra solo, sin apuntarlo.",
          "El nombre del sitio sale limpio, sin caracteres raros en medio.",
          "Una compra con la tarjeta de Trade Republic no se apunta dos veces.",
          "Un pago en otra moneda entra convertido a euros y guarda lo que costó en la moneda del sitio."],
      en:["Pay with the phone (Google Pay) using any card: the expense is logged on its own.",
          "The shop name comes out clean, with no odd characters in the middle.",
          "A purchase with the Trade Republic card isn't logged twice.",
          "A payment in another currency comes in converted to euros and keeps what it cost locally."],
      ca:["Pagar amb el mòbil (Google Pay) amb qualsevol targeta: la despesa entra sola.",
          "El nom del lloc surt net, sense caràcters estranys enmig.",
          "Una compra amb la targeta de Trade Republic no s'apunta dues vegades.",
          "Un pagament en una altra moneda entra convertit a euros i desa el que va costar al lloc."]}},
   ],
   items:{
   es:[
