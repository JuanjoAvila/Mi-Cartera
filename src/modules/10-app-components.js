  ...
  {v:"4.13.0", d:"28 jul 2026",
   ...
   tandas:[
    ...
    {id:"bancos", t:"🏦 Bancos: los bugs gordos de esta semana", items:[
      ...
      "NUEVO: el aporte automático de 50€/mes a tu fondo ya sale con su propia categoría «📈 Inversión» (ni gasto ni ingreso) en vez de contar como un gasto más — comprueba que el movimiento del aporte no infla «gastado este mes». El round-up/cashback (importes variables, TR no manda ningún dato para distinguirlos solos) sigue entrando como gasto normal: márcalo a mano como «Inversión» desde la ficha del gasto (mismo sitio que cambiar cualquier categoría) y comprueba que también desaparece del gastado y que Cartera refleja la compra en el fondo. ⚠ Si lo probaste ANTES de este aviso: había un bug gordo (marcar uno se llevaba por delante TODOS los demás «Movimiento», con compra de participaciones de más incluida) — ya está arreglado y tu cuenta se repara sola al abrir la app, pero vuelve a probarlo de cero, uno a uno.",
