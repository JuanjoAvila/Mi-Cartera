...
const KW = {
  ...
  compras:["zara","mango","primark","stradivarius","bershka","pull &","pull&","el corte","amazon","amzn","aliexpress","pccomponentes","mediamarkt","worten","nike","adidas","foot locker","alehop","ale hop","ale-hop","tiger","flying tiger","normal ","tedi","action","casa ","muy mucho","sostrene","søstrene","kiabi","lefties","springfield","cortefiel","jd sports","sprinter","shein","temu","massimo","oysho","cyrillus","calzedonia","intimissimi","clas ohlson","veritas","douglas perfum","cofidis","papeleria","papelería","copisteria","copistería","liberia","libreria","druni","primor","sephora","perfumeria","fnac ","game ","xbox store","playstation store","app store","apple store","samsung store","xiaomi store","coolmod","versus gamers","uniqlo","h&m","hm ","pull and bear","bimba y lola","tous ","pandora","swatch"],
  ...
  regalos:["regalo","flores","floristeria","floristería","joyeria","joyería","perfumeria","perfumería","interflora","teleflorist","rosas ","ramo "],
};
